    ...
    return ListView.builder(
      ...
      itemBuilder: (BuildContext context, int i) {
        ...
        // if (message.body!.toLowerCase().contains('your salary has been'))
        {
          ...
          // If the message doesn't contain 'debit' or 'credit', you might want to return something else or null.
          // You can return an empty Container or null, or simply omit the else part if you don't want to display messages that don't contain 'debit' or 'credit'.
          return Container();
        }
      },
    );
